...
class MyFrame(QWidget):
    ...
    def show_result(self):
        ...
        self.wjSimiEdit.setText(str(self.model.sentence_similarity(sen1, sen2)))
        print(self.model.sentence_similarity(sen1, sen2))
        print("计算WMD：")
        self.wmdDistanceEdit.setText(str(self.model.sentence_wmd_distance(sen1, sen2)))
        print(self.model.sentence_wmd_distance(sen1, sen2))
        print("计算SSF:")
        self.simiEdit.setText(str(ssf.calc_sen_simi(self.model, sen1, sen2)))
